function creaPersone(dati) {
  ...
  for (i = 0; i < dati.length; i++) {
    ...
    dati[i].fixedGetPosition = function(i) {
      return function() {
        return 'Position is ' + i;
      }
    }(i);
...
console.log('manuele\'s position by fixed function', manuele.fixedGetPosition());
console.log('luca\'s position by fixed function', luca.fixedGetPosition());
